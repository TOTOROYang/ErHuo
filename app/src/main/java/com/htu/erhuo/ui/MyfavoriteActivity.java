...
/**
 * Description
 * Created by yzw on 2017/4/9.
 */

public class MyFavoriteActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolBar.setTitle(R.string.str_my_favorite);
